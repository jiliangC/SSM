                ...
                <div class="row">
                    ...
                    <div>
                        <nav aria-label="Page navigation">
                            <ul class="pagination">
                                <li><a href="${APP_PATH}/typeList">首页</a></li>
                                <c:if test="${pageInfo.hasPreviousPage }">
                                    <li><a href="${APP_PATH }/typeList?pn=${pageInfo.pageNum-1}"
                                ...
                                <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                                    <c:if test="${page_Num == pageInfo.pageNum }">
                                        <li class="active"><a href="${APP_PATH}/typeList">${page_Num }</a></li>
                                    </c:if>
                                    <c:if test="${page_Num != pageInfo.pageNum }">
                                        <li><a href="${APP_PATH }/typeList?pn=${page_Num }">${page_Num }</a></li>
                                    </c:if>
                                ...
                                <li><a href="${APP_PATH }/typeList?pn=${pageInfo.pages}">末页</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
